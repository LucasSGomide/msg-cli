...
- When creating a GitButler branch for an agent session, use `<type>/<roadmap-item-id>-<short-description>`.

### Commit message convention

- Follow the `<type>: summary` commit-message convention when writing commit messages.
